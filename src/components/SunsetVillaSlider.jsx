...
import { sunsetData } from "../data/sunsetData";

import { FaChevronLeft, FaChevronRight } from "react-icons/fa";

const SunsetVillaSlider = () => {
  ...
  const handleShiftRight = () => {
    if (activeSlider === sunsetData.length - slidersNumber) {
  ...
  let modifiedSlides = sunsetData.slice(
    activeSlider,
    ...
    <div className='mt-5'>
      ...
      <div className="flex items-center justify-between max-w-5xl mx-auto pb-5 px-5">
        <div className="text-black">
            {activeSlider+1}/{sunsetData.length}
        </div>
        <div>
...
export default SunsetVillaSlider